...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText TxUsername, TxPassword, TxConPassword, TxEmail, TxNamaLengkap, TxAsalSekolah;
    Button BtnRegister;
    DBHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TxNamaLengkap = (EditText)findViewById(R.id.txNamaLengkap);
        TxAsalSekolah = (EditText)findViewById(R.id.txAsalSekolah);
        ...
        BtnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String namaLengkap  = TxNamaLengkap.getText().toString().trim();
                String asalSekolah   = TxAsalSekolah.getText().toString().trim();
                ...
                if (!password.equals(conPassword)){
                    ...
                    values.put(DBHelper.row_nama, namaLengkap);
                    values.put(DBHelper.row_sekolah, asalSekolah);
